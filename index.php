            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-12 d-flex no-block align-items-center">
                        <h2 class="page-title">Dashboard | IT Asset Overview</h2>
                        <!--
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="d-md-flex align-items-center">
                            <div>
                                <!--                                        <h4 class="card-title">IT Asset Overview</h4>-->
                                <h3 class="card-subtitle">As of
                                    <?php echo $time; ?>
                                </h3>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="flot-chart">
                                        <?php 
                                            if ($desktop == '0' && $laptop == '0' && $printer == '0' &&  $server == '0' && $storage == '0' && $network == '0')
                                            {
                                            ?>
                                                <div class="flot-chart-content text-center"><br><h3>Active IT Asset</h3><br><br>No IT Asset Discovered </div>
                                            <?php
                                            }
                                            else
                                            {
                                              ?>
                                         <div class="flot-chart-content" id="actchart"></div>
                        ...
                        <div class="col-lg-4">
                            <div class="flot-chart">
                                    <?php 
                                            if ($desktop_decom == '0' && $laptop_decom == '0' && $printer_decom == '0' &&  $server_decom == '0' && $storage_decom == '0' && $network_decom == '0')
                                            {
                                            ?>
                                                <div class="flot-chart-content text-center"><br><h3>Decomm IT Asset</h3><br><br>No Decommission IT Asset Discovered </div>
                                            <?php
                                            }
                                            else
                                            {
                                              ?>
                                       <div class="flot-chart-content" id="decchart"></div>
                        ...
                        <div class="col-lg-4">
                            <div class="flot-chart">
                                      <?php 
                                            if ($desktop_dist == '0' && $laptop_dist == '0' && $printer_dist == '0' &&  $server_dist == '0' && $storage_dist == '0' && $network_dist == '0')
                                            {
                                            ?>
                                                <div class="flot-chart-content text-center"><br><h3>Dispose IT Asset</h3><br><br>No Dispose IT Asset Discovered </div>
                                            <?php
                                            }
                                            else
                                            {
                                              ?>
                                      <div class="flot-chart-content" id="dischart"></div>
                        ...
                        <!--
                                    <div class="col-lg-3">
                                        <div class="flot-chart">
                                          <img style="padding-top:25%;"src="../../assets/images/legend.png">
                                        </div>
                                    </div>
-->
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">IT Asset Status</h4>
                                        <h5 class="card-subtitle">As of <?php echo $time; ?> </h5>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">Newly Discovered IT Asset</h4>
                ...
                <!--
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-md-flex align-items-center">
                                    <div>
                                        <h4 class="card-title">IT Asset Not Reporting > 30 Days </h4>
